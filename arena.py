...
class Arena:
    ...
    def create_weapon(self):
        ...
        # Prompt the user for necessary information to create a new weapon object.
    ...
    def create_armor(self):
        ...
        #  Prompt the player for the information to create a new armor object.
        #  return the new armor object with values set by player.
        name = input("What is the ability name?  ")
        max_block = input(
